...
<?
    ...
    print("<INPUT type=hidden name=item value=$serial_number >");
    print("<INPUT type=hidden name=item value=$info >");
    print("<INPUT type=hidden name=item value=$desc >");
   ...
   // print("<td style='width:20%;border-top:1px solid red;border-bottom:1px solid red;'> <input type='file' name='pic' accept='image/'></td>");
    print("<td style='width:25%;border-top:1px solid red;border-bottom:1px solid red;'><textarea type='text' name='contact information' rows='5' cols='50' maxlength='500'>$info </textarea></td>");
